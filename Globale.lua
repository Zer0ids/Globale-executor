...
local GlobaleExecutor = Instance.new("ScreenGui")
...
GlobaleExecutor.Name = "GlobaleExecutor"
GlobaleExecutor.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
GlobaleExecutor.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
GlobaleExecutor.ResetOnSpawn = false

Topbar.Name = "Topbar"
Topbar.Parent = GlobaleExecutor
Topbar.Active = true
